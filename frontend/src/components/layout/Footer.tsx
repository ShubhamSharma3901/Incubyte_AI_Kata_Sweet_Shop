...
const Footer: React.FC = () => {
	return (
		<footer className="relative mt-auto border-t border-white/40 bg-white/60 px-4 py-6 text-sm text-neutral-500 shadow-inner shadow-white/40 backdrop-blur-xl transition-colors dark:border-neutral-800/70 dark:bg-neutral-950/70 dark:text-neutral-400 dark:shadow-black/40 sm:px-6">
